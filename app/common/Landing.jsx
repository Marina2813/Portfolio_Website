...
const Landing = ({heading,description,accentcolor}) => {
  ...
  return (
    <div className="h-[80vh]">
      <div id="HEADINGS" ref={headingRef}>
        <h1 className="font-bold text-7xl flex items-end">
          {heading}{" "}
          <div
            className={`h-4 w-4 mb-2 ml-2 bg-${accentcolor} rounded-full`}
            id="oval"
          ></div>
        </h1>
        <div
          ref={animatedDivRef}
          className={`bg-${accentcolor} h-1 w-full mt-6 rounded-xl`}
          id="line"
        ></div>
      </div>
